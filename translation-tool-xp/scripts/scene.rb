...
#------------------------------------------------------------------------
  def initialize
		...
		@window.title("XP Translate Tool",35)
		@window.active = true
